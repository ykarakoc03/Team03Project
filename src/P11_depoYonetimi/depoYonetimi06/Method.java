...
public class Method implements
    ...
    private static void urunTanimlama() {
        try {
            ...
            stringKontrol(urunIsmi);
            System.out.println("Uretici firma");
            String uretici = scan.nextLine();
            stringKontrol(uretici);
    ...
    public static void stringKontrol(String str) {
        if (str.isEmpty()) {
            throw new InputMismatchException("bu alan boş bırakılamaz... lütfen tekrar deneyiniz");
        }
    }
    ...
    private static void urunCikis() {
        ...
        if (urunler.containsKey(arananId)) {
            ...
            if (urunler.get(arananId).getMiktar() >= guncelMik)
                ...
                System.out.println("Mevcut miktardan fazla ürün girişi yaptınız Lütfen tekrar deneyiniz");
                urunCikis();
            }
        } else {
            System.out.println("aradiniz urun yok");
